...
if ( ! function_exists( 'understrap_scripts' ) ) {
    ...
    wp_enqueue_style( 'main-styles', get_stylesheet_directory_uri() . '/style.css', array());
		...
		wp_enqueue_script( 'carousel-scripts', get_template_directory_uri() . '/js/carousel.js', array(), $theme_version, true);
		wp_enqueue_script( 'customizer-scripts', get_template_directory_uri() . '/js/customizer.js', array(), $theme_version, true);
